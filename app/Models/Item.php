...
class Item extends Model
{
    ...
    public function owner()
    {
        if($this->creator_type == 1)
        {
            ...
            return $this->belongsTo(Group::class, 'creator_id');
        }
    }
    ...
    public function avgResalePrice()
    {
        ...
        $averageSalesPrice = DB::table('item_data')
            ->where('item_id', $this->id)
            ->avg('price');
    ...
    {
        return $this->hasMany(Post::class, 'target_id')->where('target_type', '=', '1');
    }
