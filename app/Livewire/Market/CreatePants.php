...
class CreatePants extends Component
{
    use WithFileUploads;
    ...
    public function submit()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('market.item', $item)->with('success', 'Pants uploaded successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
            Redis::del($lockKey);
            return $this->dispatch('toast:error', 'An error occurred while uploading your pants. Please try again.');
        }
    }
    ...
    {
        return view('livewire.market.create-pants');
    }
}
